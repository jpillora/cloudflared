...
.PHONY: vet
vet:
	$Q go vet -mod=readonly github.com/jpillora/cloudflared/...

.PHONY: fmt
fmt:
	@goimports -l -w -local github.com/jpillora/cloudflared $$(go list -mod=readonly -f '{{.Dir}}' -a ./... | fgrep -v tunnelrpc/proto)
